...
export const API_ENDPOINTS = {
  ...
  // Question Groups
  QUESTION_GROUPS: "api/question-groups",
  QUESTION_GROUP_BY_ID: (id: string) => `api/question-groups/${id}`,
  QUESTION_GROUPS_BY_TEST: (testId: string) => `api/tests/${testId}/question-groups`,
  
  // QuestionGroup Questions
  GROUP_QUESTIONS: "api/group-questions",
  GROUP_QUESTION_BY_ID: (id: string) => `api/group-questions/${id}`,
  GROUP_QUESTIONS_BY_GROUP: (groupId: string) => `api/question-groups/${groupId}/questions`,
